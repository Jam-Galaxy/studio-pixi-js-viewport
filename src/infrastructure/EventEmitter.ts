/**
 * EventEmitter from the wavesurfer.js package. 
...
type EventMap<EventTypes extends BaseEventMap> = {
  [EventName in keyof EventTypes]: Set<EventListener<EventTypes, EventName>>
}

/** A simple event emitter that can be used to listen to and emit events. */
class EventEmitter<EventTypes extends BaseEventMap> implements IEventEmitter<EventTypes> {
  ...
  /** Emit an event */
  public emit<EventName extends keyof EventTypes>(eventName: EventName, ...args: EventTypes[EventName]): void {
